<template>
  ...
  >
    <div class="w-full h-full">
      <div class="min-w-full h-7 flex justify-end items-center p-1">
        <XMarkIcon
          class="w-6 h-6 text-slate-700 dark:text-slate-200 cursor-pointer"
          @click="closeDrawer"
        />
      </div>
      <div class="min-w-full h-full p-2">
        <slot></slot>
      </div>
    </div>
  </div>
